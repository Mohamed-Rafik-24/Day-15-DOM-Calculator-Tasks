...
let cont =  document.createElement('div');   //creating container
document.body.appendChild(cont);
cont.setAttribute("class","container  col-6 col-md-4 col-xl-3  mt-5  ") 

let calRow =  document.createElement('div'); //creating the row for the alignment 
cont.appendChild(calRow);
calRow.setAttribute("class","row cal-c col-10 col-lg-8 d-flex gap-2 shadow-lg flex-column align-content-center rounded-3 pb-2 ")
